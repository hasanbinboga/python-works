...
if(check_errors[1] > 0):
   print("Error " + check_errors[1])
    ...
    print("Game Succesfuly initailized")
    ...
    while True:
        ...
        #GFX
        game_window.fill(darkblue)

        for pos in snake_body:
            pygame.draw.rect(game_window, cyan, pygame.Rect(
                pos[0] + 2, pos[1] + 2,
                square_size -2, square_size))
        
        pygame.draw.rect(game_window,magenta, pygame.Rect(food_pos[0],
